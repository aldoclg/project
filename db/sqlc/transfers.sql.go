...
SELECT id, from_account_id, to_account_id, created_at, amount FROM transfers WHERE id = $1 LIMIT 1
`
...
SELECT id, from_account_id, to_account_id, created_at, amount FROM transfers ORDER BY id LIMIT $1 OFFSET $2
`
...
UPDATE transfers SET amount = $2 WHERE id = $1 RETURNING id, from_account_id, to_account_id, created_at, amount
`
